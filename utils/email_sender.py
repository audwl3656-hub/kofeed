...
{"연도별 Z-Score 대시보드(HTML 파일)도 함께 첨부하였습니다. 파일을 저장 후 브라우저에서 열어 확인하시기 바랍니다(단순 참고용, 이전 z스코어와 다를 수 있습니다)." if html_dashboard else ""}

본 메일은 단순 발송용이니, 문의 사항이 있으시면 한국사료협회로 전화 부탁드립니다.
